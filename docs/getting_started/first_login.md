...
1. Check the inbox of the email address used to create your account.

2. Look for an email with the subject "Verify email".

3. Click the "Link to e-mail address verification" link inside the message.
