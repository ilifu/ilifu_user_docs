...
Other files also exist for some of these snapshots and are available to be used for your science. Blackhole details can be found for the 100 Mpc box within */idia/data/laduma/SIMBA/m100n1024/s50/blackhole_details/bhALL.hdf5*. The 50 Mpc Simba snapshots also have additional 3D maps and power spectra generated by [Mauro Roncarelli](mauro.roncarelli@inaf.it), within */idia/data/laduma/SIMBA/m50n512/mauro/*. For further information, please check the README file: */idia/data/laduma/SIMBA/m50n512/mauro/README.md*.
...
- **m100n1024** - 100 Mpc/h box, 2x1024<sup>3</sup> particles. All snapshots are available. This is the Flagship full Simba-C physics run.
...
- **m25n512** - 25 Mpc/h box, 2x512<sup>3</sup> particles (High-Resolution Run). All snapshots are available. This is the Flagship full Simba-C physics run.
